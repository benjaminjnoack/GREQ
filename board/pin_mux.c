...
board: FRDM-K66F
pin_labels:
- {pin_num: A1, pin_signal: PTD7/CMT_IRO/UART0_TX/FTM0_CH7/SDRAM_CKE/FTM0_FLT1/SPI1_SIN, label: 'J6[7]/SPI1_SIN/MISO', identifier: SIN}
...
- {pin_num: A2, pin_signal: ADC0_SE7b/PTD6/LLWU_P15/SPI0_PCS3/UART0_RX/FTM0_CH6/FB_AD0/FTM0_FLT0/SPI1_SOUT, label: 'J6[6]/SPI1_SOUT/MOSI', identifier: SOUT}
...
- {pin_num: A3, pin_signal: ADC0_SE6b/PTD5/SPI0_PCS2/UART0_CTS_b/UART0_COL_b/FTM0_CH5/FB_AD1/SDRAM_A9/EWM_OUT_b/SPI1_SCK, label: 'J6[7]/SPI1_SCK/SCK', identifier: SCK}
...
- {pin_num: A4, pin_signal: PTD4/LLWU_P14/SPI0_PCS1/UART0_RTS_b/FTM0_CH4/FB_AD2/SDRAM_A10/EWM_IN/SPI1_PCS0, label: 'J6[4]/SPI1_PCS0/CS', identifier: PCS}
...
- {pin_num: C4, pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/SDRAM_A12/I2C0_SCL, label: 'J2[8]/SPI0_SOUT/FB_AD4', identifier: DEBUG}
...
- {pin_num: M4, pin_signal: ADC0_SE17/PTE24/CAN1_TX/UART4_TX/I2C0_SCL/EWM_OUT_b, label: 'J2[13]/ADC0_SE17', identifier: SCL}
- {pin_num: A5, pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, label: 'J2[6]/SPI0_PCS0/FTM3_CH0', identifier: BUTTON}
...
- {pin_num: J5, pin_signal: TSI0_CH1/PTA0/UART0_CTS_b/UART0_COL_b/FTM0_CH5/LPUART0_CTS_b/JTAG_TCLK/SWD_CLK/EZP_CLK, label: 'J8[2]/J9[4]/JTAG_TCLK/SWD_CLK/EZP_CLK',
  identifier: SWD_CLK}
- {pin_num: K5, pin_signal: ADC0_SE18/PTE25/LLWU_P21/CAN1_RX/UART4_RX/I2C0_SDA/EWM_IN, label: 'J2[15]/ADC0_SE18', identifier: SDA}
...
- {pin_num: A9, pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/SDRAM_A19/CMP1_OUT, label: 'J1[4]/UART1_TX/FTM0_CH3/FB_AD11', identifier: Strobe}
...
- {pin_num: A11, pin_signal: CMP1_IN1/PTC3/LLWU_P7/SPI0_PCS1/UART1_RX/FTM0_CH2/CLKOUT/I2S0_TX_BCLK, label: 'J1[2]/UART1_RX/FTM0_CH2/CLKOUT', identifier: Reset}
...
- {pin_num: D11, pin_signal: TSI0_CH12/PTB19/CAN0_RX/FTM2_CH1/I2S0_TX_FS/FB_OE_b/FTM2_QD_PHB/TPM2_CH1, label: 'J2[4]/FTM2_CH1', identifier: PHASE_B}
...
- {pin_num: D12, pin_signal: TSI0_CH11/PTB18/CAN0_TX/FTM2_CH0/I2S0_TX_BCLK/FB_AD15/SDRAM_A23/FTM2_QD_PHA/TPM2_CH0, label: 'J2[2]/FTM2_CH0', identifier: PHASE_A}
...
- {pin_num: J12, pin_signal: CMP3_IN5/PTA25/MII0_TXCLK/FB_A28, label: 'J1[16]/CMP3_IN5', identifier: DEBUG_PIN}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
HT16K33:
- options: {callFromInitBoot: 'true', prefix: HT16K33_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: M4, peripheral: I2C0, signal: SCL, pin_signal: ADC0_SE17/PTE24/CAN1_TX/UART4_TX/I2C0_SCL/EWM_OUT_b, open_drain: enable}
  - {pin_num: K5, peripheral: I2C0, signal: SDA, pin_signal: ADC0_SE18/PTE25/LLWU_P21/CAN1_RX/UART4_RX/I2C0_SDA/EWM_IN, open_drain: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void HT16K33(void)
{
    ...
    PORT_SetPinMux(HT16K33_SCL_PORT, HT16K33_SCL_PIN, kPORT_MuxAlt5);
    ...
    PORT_SetPinMux(HT16K33_SDA_PORT, HT16K33_SDA_PIN, kPORT_MuxAlt5);
...
- pin_list:
  - {pin_num: B2, peripheral: GPIOD, signal: 'GPIO, 11', pin_signal: PTD11/LLWU_P25/SPI2_PCS0/SDHC0_CLKIN/LPUART0_CTS_b/FB_A19, direction: INPUT, gpio_interrupt: kPORT_InterruptEitherEdge,
    pull_select: up, pull_enable: enable}
  - {pin_num: M9, peripheral: GPIOA, signal: 'GPIO, 10', pin_signal: PTA10/LLWU_P22/FTM2_CH0/MII0_RXD2/FTM2_QD_PHA/TPM2_CH0/TRACE_D0, direction: INPUT, gpio_interrupt: kPORT_InterruptEitherEdge,
    pull_select: up, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitBUTTONs(void)
{
    ...
    /* Interrupt configuration on PORTA10 (pin M9): Interrupt on either edge */
    PORT_SetPinInterruptConfig(BOARD_SW3_PORT, BOARD_SW3_PIN, kPORT_InterruptEitherEdge);
    ...
    /* Interrupt configuration on PORTD11 (pin B2): Interrupt on either edge */
    PORT_SetPinInterruptConfig(BOARD_SW2_PORT, BOARD_SW2_PIN, kPORT_InterruptEitherEdge);
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
MSGEQ7:
- options: {callFromInitBoot: 'true', prefix: MSGEQ7_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: A11, peripheral: GPIOC, signal: 'GPIO, 3', pin_signal: CMP1_IN1/PTC3/LLWU_P7/SPI0_PCS1/UART1_RX/FTM0_CH2/CLKOUT/I2S0_TX_BCLK, direction: OUTPUT}
  - {pin_num: A9, peripheral: GPIOC, signal: 'GPIO, 4', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/SDRAM_A19/CMP1_OUT, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: A12, peripheral: ADC0, signal: 'SE, 4b', pin_signal: ADC0_SE4b/CMP1_IN0/TSI0_CH15/PTC2/SPI0_PCS2/UART1_CTS_b/FTM0_CH1/FB_AD12/SDRAM_A20/I2S0_TX_FS}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void MSGEQ7(void)
{
    ...
    GPIO_PinInit(MSGEQ7_Reset_GPIO, MSGEQ7_Reset_PIN, &Reset_config);

    gpio_pin_config_t Strobe_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PTC4 (pin A9)  */
    GPIO_PinInit(MSGEQ7_Strobe_GPIO, MSGEQ7_Strobe_PIN, &Strobe_config);

    /* PORTC2 (pin A12) is configured as ADC0_SE4b */
    PORT_SetPinMux(MSGEQ7_Out_PORT, MSGEQ7_Out_PIN, kPORT_PinDisabledOrAnalog);

    /* PORTC3 (pin A11) is configured as PTC3 */
    PORT_SetPinMux(MSGEQ7_Reset_PORT, MSGEQ7_Reset_PIN, kPORT_MuxAsGpio);

    /* PORTC4 (pin A9) is configured as PTC4 */
    PORT_SetPinMux(MSGEQ7_Strobe_PORT, MSGEQ7_Strobe_PIN, kPORT_MuxAsGpio);
}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
POTENTIOMETER:
- options: {callFromInitBoot: 'true', prefix: POTENTIOMETER_, coreID: core0, enableClock: 'true'}
- pin_list:
...
void POTENTIOMETER(void)
{
    ...
    PORT_SetPinMux(POTENTIOMETER_ADC1_SE10_PORT, POTENTIOMETER_ADC1_SE10_PIN, kPORT_PinDisabledOrAnalog);

    /* PORTB5 (pin G9) is configured as ADC1_SE11 */
    PORT_SetPinMux(POTENTIOMETER_ADC1_SE11_PORT, POTENTIOMETER_ADC1_SE11_PIN, kPORT_PinDisabledOrAnalog);

    /* PORTB6 (pin F12) is configured as ADC1_SE12 */
    PORT_SetPinMux(POTENTIOMETER_ADC1_SE12_PORT, POTENTIOMETER_ADC1_SE12_PIN, kPORT_PinDisabledOrAnalog);

    /* PORTB7 (pin F11) is configured as ADC1_SE13 */
    PORT_SetPinMux(POTENTIOMETER_ADC1_SE13_PORT, POTENTIOMETER_ADC1_SE13_PIN, kPORT_PinDisabledOrAnalog);
}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
ROTARY_ENCODER:
- options: {callFromInitBoot: 'true', prefix: ROTARY_ENCODER_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: A5, peripheral: GPIOD, signal: 'GPIO, 0', pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, direction: INPUT, gpio_interrupt: kPORT_InterruptEitherEdge}
  - {pin_num: D12, peripheral: GPIOB, signal: 'GPIO, 18', pin_signal: TSI0_CH11/PTB18/CAN0_TX/FTM2_CH0/I2S0_TX_BCLK/FB_AD15/SDRAM_A23/FTM2_QD_PHA/TPM2_CH0, direction: INPUT,
    gpio_interrupt: kPORT_InterruptRisingEdge, pull_select: up, pull_enable: disable}
  - {pin_num: D11, peripheral: GPIOB, signal: 'GPIO, 19', pin_signal: TSI0_CH12/PTB19/CAN0_RX/FTM2_CH1/I2S0_TX_FS/FB_OE_b/FTM2_QD_PHB/TPM2_CH1, direction: INPUT,
    gpio_interrupt: kPORT_InterruptRisingEdge, pull_select: up, pull_enable: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void ROTARY_ENCODER(void)
{
    ...
    GPIO_PinInit(ROTARY_ENCODER_PHASE_A_GPIO, ROTARY_ENCODER_PHASE_A_PIN, &PHASE_A_config);
    ...
    GPIO_PinInit(ROTARY_ENCODER_PHASE_B_GPIO, ROTARY_ENCODER_PHASE_B_PIN, &PHASE_B_config);
    ...
    GPIO_PinInit(ROTARY_ENCODER_BUTTON_GPIO, ROTARY_ENCODER_BUTTON_PIN, &BUTTON_config);

    /* PORTB18 (pin D12) is configured as PTB18 */
    PORT_SetPinMux(ROTARY_ENCODER_PHASE_A_PORT, ROTARY_ENCODER_PHASE_A_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTB18 (pin D12): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(ROTARY_ENCODER_PHASE_A_PORT, ROTARY_ENCODER_PHASE_A_PIN, kPORT_InterruptRisingEdge);
    ...
    PORT_SetPinMux(ROTARY_ENCODER_PHASE_B_PORT, ROTARY_ENCODER_PHASE_B_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTB19 (pin D11): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(ROTARY_ENCODER_PHASE_B_PORT, ROTARY_ENCODER_PHASE_B_PIN, kPORT_InterruptRisingEdge);
    ...
    PORT_SetPinMux(ROTARY_ENCODER_BUTTON_PORT, ROTARY_ENCODER_BUTTON_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTD0 (pin A5): Interrupt on either edge */
    PORT_SetPinInterruptConfig(ROTARY_ENCODER_BUTTON_PORT, ROTARY_ENCODER_BUTTON_PIN, kPORT_InterruptEitherEdge);
}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
MAX7219:
- options: {callFromInitBoot: 'true', prefix: MAX7219_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: A3, peripheral: SPI1, signal: SCK, pin_signal: ADC0_SE6b/PTD5/SPI0_PCS2/UART0_CTS_b/UART0_COL_b/FTM0_CH5/FB_AD1/SDRAM_A9/EWM_OUT_b/SPI1_SCK, direction: OUTPUT}
  ...
  - {pin_num: A4, peripheral: SPI1, signal: PCS0_SS, pin_signal: PTD4/LLWU_P14/SPI0_PCS1/UART0_RTS_b/FTM0_CH4/FB_AD2/SDRAM_A10/EWM_IN/SPI1_PCS0, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void MAX7219(void)
{
    ...
    PORT_SetPinMux(MAX7219_PCS_PORT, MAX7219_PCS_PIN, kPORT_MuxAlt7);

    /* PORTD5 (pin A3) is configured as SPI1_SCK */
    PORT_SetPinMux(MAX7219_SCK_PORT, MAX7219_SCK_PIN, kPORT_MuxAlt7);

    /* PORTD6 (pin A2) is configured as SPI1_SOUT */
    PORT_SetPinMux(MAX7219_SOUT_PORT, MAX7219_SOUT_PIN, kPORT_MuxAlt7);

    /* PORTD7 (pin A1) is configured as SPI1_SIN */
    PORT_SetPinMux(MAX7219_SIN_PORT, MAX7219_SIN_PIN, kPORT_MuxAlt7);
}
...
void GP(void)
{
    ...
    GPIO_PinInit(GP_DEBUG_GPIO, GP_DEBUG_PIN, &DEBUG_config);

    /* PORTD2 (pin C4) is configured as PTD2 */
    PORT_SetPinMux(GP_DEBUG_PORT, GP_DEBUG_PIN, kPORT_MuxAsGpio);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
